...
folder are mapped to the application's root namespace, 'TestDemoExt601'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'TestDemoExt601' in the same way
as `"TestDemoExt601/sass/src"`.
